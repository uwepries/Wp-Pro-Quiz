...
class WpProQuiz_View_QuizEdit extends WpProQuiz_View_View
{
    ...
    private function tabBar()
    {
        ...
        <div class="nav-tab-wrapper wpProQuiz-top-tab-wrapper">
            <a href="#tabGeneral" data-tab="tabGeneral" class="nav-tab nav-tab-active"><?php _e('General', 'wp-pro-quiz'); ?></a>
            <a href="#tabResult" data-tab="tabResult" class="nav-tab "><?php _e('Result', 'wp-pro-quiz'); ?></a>
            <a href="#tabOptions" data-tab="tabOptions" class="nav-tab "><?php _e('Options', 'wp-pro-quiz'); ?></a>
            <a href="#tabCustomFields" data-tab="tabCustomFields" class="nav-tab "><?php _e('Custom fields', 'wp-pro-quiz'); ?></a>
            <a href="#tabLeaderboard" data-tab="tabLeaderboard" class="nav-tab "><?php _e('Leaderboard', 'wp-pro-quiz'); ?></a>
            <a href="#tabEmailSettings" data-tab="tabEmailSettings" class="nav-tab "><?php _e('Email Settings', 'wp-pro-quiz'); ?></a>
